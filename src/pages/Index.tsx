    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 pb-16">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="text-center mb-12">
          <h1 className="font-display text-4xl md:text-5xl text-foreground leading-tight">Where can we take you?</h1>
          <p className="mt-3 font-body text-muted-foreground text-base max-w-md mx-auto">Choose the space you're in. We'll connect you with people nearby.</p>
        </motion.div>
